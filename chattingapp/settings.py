...
SECRET_KEY = 'django-insecure--zvwsu%2&*9_+3l7(^y=*)(^+ekz7ft0heul37$_(fk7!0w7s$'
...
# Media Files Storage (Local for Development, Cloudinary for Production)
if not DEBUG:
    # Add Cloudinary apps dynamically in production
    INSTALLED_APPS += [
        'cloudinary_storage',
        'cloudinary',
    ]
